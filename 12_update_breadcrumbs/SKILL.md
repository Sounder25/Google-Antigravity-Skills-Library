...
# SKILL-012: Update Intent Breadcrumbs
...
```powershell
.\skills\12_update_breadcrumbs\update_breadcrumbs.ps1 -Status "active" -Objective "Stabilize release" -NextSteps "Run test suite", "Fix failures"
```
