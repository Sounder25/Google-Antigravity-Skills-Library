...
# SKILL-012 — State Overlay Consistency Checker
...
| Skill | Role |
|-------|------|
| **SKILL-003** | Requires invariants |
| **SKILL-001** | Detects stuck execution |
| **SKILL-006** | Hard pre-execution gate |
| **SKILL-017** | Red-team scenario gen |
| **SKILL-023** | Postmortem logging |
